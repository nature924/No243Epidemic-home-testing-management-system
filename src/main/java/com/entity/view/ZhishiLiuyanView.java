...
public class ZhishiLiuyanView extends ZhishiLiuyanEntity implements Serializable {
	...
	public ZhishiLiuyanView() {

	}

	public ZhishiLiuyanView(ZhishiLiuyanEntity zhishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zhishiLiuyanEntity);
